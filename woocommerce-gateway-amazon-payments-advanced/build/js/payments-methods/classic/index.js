...
var $forEach = __webpack_require__(3610);
...
var IteratorPrototype = __webpack_require__(5143);
...
__webpack_unused_export__ = DESCRIPTORS && !V8_PROTOTYPE_DEFINE_BUG ? Object.defineProperties : function defineProperties(O, Properties) {
  anObject(O);
...
/* unused reexport */ __webpack_require__(6279);
...
const maybeRemoveEditButton = () => {
  ...
  if (editAddressButton && editAddressButton.length > 0) {
    _forEachInstanceProperty(editAddressButton).call(editAddressButton, button => {
      button.remove();
    });
  }
};
